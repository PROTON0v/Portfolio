              ...
              <div>
                ...
                <div className="space-y-4 sm:space-y-6">
                  <p className={`leading-relaxed  text-muted-foreground`}>
                    I started coding out of curiosity — wanting to understand
                    how digital products work. That curiosity turned into a
                    passion for building sleek, fast, and user-focused
                    applications.
                  </p>
